...
public class CachedThreadPool implements ThreadPool {
	...
	public ExecutorService getExecutor(ThreadPoolConfig threadPoolConfig) {
		...
		int threads = NumberUtils.defaultValue(threadPoolConfig.getThreads(), Integer.MAX_VALUE);
		long alive = NumberUtils.defaultValue(threadPoolConfig.getAlive(), Constants.DEFAULT_ALIVE);
